...
const playRound = () => {
  ...
  crystals
    ...
    // the 0.5 is used to make the sort random. 0.5 - Math.random() will return a number between -0.5 and 0.5. If the number is positive, it will be sorted to the end of the array. If the number is negative, it will be sorted to the beginning of the array.
