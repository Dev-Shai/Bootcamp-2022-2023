...
// let is block scoped, so it doesn't exist outside of the for-loop block. but var is function scoped or global scoped, so it does exist outside of the for-loop block. const is also block scoped, so it doesn't exist outside of the for-loop block.
...
// declaration is fine outside of the scope but but it is the defining of it and the assigning of it that is not allowed outside of the scope.